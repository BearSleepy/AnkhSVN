	...
	class ShowRevisionProperties : ICommandHandler
	{
		...
		public void OnExecute(CommandEventArgs e)
		{
			...
			using (PropertyEditorDialog dialog = new PropertyEditorDialog(selectedLog.RepositoryRoot, selectedLog.Revision, true))
			{
				...
				if (!e.GetService<IProgressRunner>().RunModal(Resources.RetrievingRevisionProperties,
				...
				ProgressRunnerResult result = progressRunner.RunModal(Resources.UpdatingRevisionProperties,
