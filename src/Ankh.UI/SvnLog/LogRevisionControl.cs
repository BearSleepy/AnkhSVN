	...
	partial class LogRevisionControl : ListViewWithSelection<LogRevisionItem>, ICurrentItemSource<ISvnLogItem>
	{
		...
		private void OnCopy(object sender, CommandEventArgs e)
		{
			...
			foreach (LogRevisionItem lri in SelectedItems)
			{
				...
				sb.AppendFormat(Resources.LogRevision, lri.Revision);
				sb.AppendLine();
				sb.AppendFormat(Resources.LogAuthor, lri.Author);
				sb.AppendLine();
				sb.AppendFormat(Resources.LogDate, lri.Date);
				sb.AppendLine();
				sb.Append(Resources.LogMessagePrefix);
				sb.AppendLine();
				sb.Append(lri.LogMessage);
				sb.AppendLine();
				sb.Append(Resources.LogMessageSuffix);
				sb.AppendLine();
			}
