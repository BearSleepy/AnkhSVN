...
namespace Ankh.UI.MergeWizard
{
	...
	public partial class MergeWizard : Wizard
	{
		...
		public MergeWizard(IAnkhServiceProvider context, SvnItem mergeTarget)
		{
			...
			DefaultPageImage = ResourcesMergeImage.MergeWizardHeader;

			MergeUtils = new MergeUtils(context);
			MergeTarget = mergeTarget;

			Text = ResourcesMerge.MergeWizardTitle;
		...
		public void PerformMerge()
		{
			...
			Context.GetService<IProgressRunner>().RunModal(ResourcesMerge.MergingTitle, runnerArgs,
				delegate(object sender, ProgressWorkerArgs ee)
				{
					...
					try
					{
						...
						else
						{
							...
							{
								throw new Exception(ResourcesMerge.NoLogItems);
							}
		...
		public override System.Drawing.Image DefaultPageImage
		{
			get
			{
				return ResourcesMergeImage.MergeWizardHeader;
			}
		}
