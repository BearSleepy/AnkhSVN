...
namespace Ankh.UI.MergeWizard
{
	public partial class MergeOptionsPage : BaseWizardPage
	{
		...
		public MergeOptionsPage()
		{
			...
			Text = ResourcesMerge.MergeOptionsHeaderTitle;
			this.Description = ResourcesMerge.MergeOptionsHeaderMessage;
			InitializeComponent();
		}
		...
		private void depthComboBox_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (box.Text == ResourcesMerge.SvnDepthInfinity)
				depth = SvnDepth.Infinity;
			else if (box.Text == ResourcesMerge.SvnDepthChildren)
				depth = SvnDepth.Children;
			else if (box.Text == ResourcesMerge.SvnDepthFiles)
				depth = SvnDepth.Files;
			else if (box.Text == ResourcesMerge.SvnDepthEmpty)
