...
namespace Ankh.UI.MergeWizard
{
	...
	{
		public static readonly WizardMessage READY_FOR_MERGE = new WizardMessage(ResourcesMerge.ReadyForMerge,
			WizardMessage.MessageType.None);
		public static readonly WizardMessage NOT_READY_FOR_MERGE = new WizardMessage(ResourcesMerge.NotReadyForMerge,
		...
		public MergeBestPracticesPage()
		{
			...
			Text = ResourcesMerge.MergeBestPracticesPageHeaderTitle;
			Description = ResourcesMerge.MergeBestPracticesPageHeaderMessage;
			InitializeComponent();
		}
			...
			bool passed)
		{
			...
			{
				if (passed)
					pBox.Image = ResourcesMergeImage.Success;
				else
					pBox.Image = ResourcesMergeImage.Error;
			}
		}
