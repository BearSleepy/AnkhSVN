...
namespace Ankh.UI.PendingChanges.Synchronize
{
	class SynchronizeListView : ListViewWithSelection<SynchronizeListItem>
	{
		...
		void Initialize()
		{
			...
			SmartColumn localChange = new SmartColumn(this, Resources.LocalChangeColumn, 102, "LocalChange");
			SmartColumn remoteChange = new SmartColumn(this, Resources.RemoteChangeColumn, 102, "RemoteChange");
