...
namespace Ankh.UI.OptionsPages
{
	partial class UserToolSettingsControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.patchBrowseBtn.Location = new System.Drawing.Point(366, 98);
			...
			this.patchExeBox.Location = new System.Drawing.Point(0, 101);
			...
			// floatVSDiffViewers
			//
			this.floatVSDiffViewers.AutoSize = true;
			this.floatVSDiffViewers.Location = new System.Drawing.Point(0, 151);
			this.floatVSDiffViewers.Name = "floatVSDiffViewers";
			this.floatVSDiffViewers.Size = new System.Drawing.Size(267, 17);
			this.floatVSDiffViewers.TabIndex = 10;
			this.floatVSDiffViewers.Text = "Create Visual Studio Diff/Merge documents floating";
			this.floatVSDiffViewers.UseVisualStyleBackColor = true;
			//
			// forceExternalBrowser
			//
			this.forceExternalBrowser.AutoSize = true;
			this.forceExternalBrowser.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			this.forceExternalBrowser.Location = new System.Drawing.Point(0, 128);
			this.forceExternalBrowser.Name = "forceExternalBrowser";
			this.forceExternalBrowser.Size = new System.Drawing.Size(302, 17);
			this.forceExternalBrowser.TabIndex = 9;
			this.forceExternalBrowser.Text = "Use E&xternal Webbrowser instead of Visual Studio browser";
