...
namespace Ankh.Scc {
	...
	internal class Resources {
		...
		/// <summary>
		///   Looks up a localized string similar to The Solution root is used for operations on the solution. E.g. Clicking update on the solution updates everything below this location and checking out the solution will download everything under this location. Normally this path is the root of your project and all dependencies in the same solution..
		/// </summary>
		internal static string ChangeSolutionRoot {
			get {
				return ResourceManager.GetString("ChangeSolutionRoot", resourceCulture);
			}
		}

		/// <summary>
		///   Looks up a localized string similar to Checking Out Project.
		/// </summary>
		...
		///   Looks up a localized resource of type System.Drawing.Bitmap.
		/// </summary>
		internal static System.Drawing.Bitmap DisconnectButton {
			get {
				object obj = ResourceManager.GetObject("DisconnectButton", resourceCulture);
				return ((System.Drawing.Bitmap)(obj));
			}
		}
		...
		/// <summary>
		///   Looks up a localized string similar to The disk drive that contains your Solution File is formatted with the FAT or FAT32 file system.
		///
		///For better Subversion stability and greater Visual Studio performance it is recommended to upgrade this file system to a more modern filesystem such as NTFS (Harddrives) or exFAT (Memory sticks)..
		/// </summary>
		internal static string SccFilesystemWarning {
			get {
				return ResourceManager.GetString("SccFilesystemWarning", resourceCulture);
			}
		}
