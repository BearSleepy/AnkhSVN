	...
	class SolutionUpdateCommand : CommandBase
	{
		...
		public override void OnExecute(CommandEventArgs e)
		{
			...
			else if (IsFolderCommand(e.Command))
			{
				...
				using (UpdateDialog ud = new UpdateDialog())
				{
					ud.Text = Resources.UpdateFolder;
					ud.FolderLabelText = Resources.UpdateFolderLabel;
			...
			else
			{
				...
				using (UpdateDialog ud = new UpdateDialog())
				{
					ud.Text = Resources.UpdateProject;
			...
			using (lck.MonitorChangesForReload())
			{
				...
				if (IsSolutionCommand(e.Command))
					title = Resources.UpdatingSolution;
				else if (IsFolderCommand(e.Command))
					title = Resources.UpdatingFolder;
				else
					title = Resources.UpdatingProject;
				...
				{
					ci.OnLastChanged(new LastChangedEventArgs(Resources.UpdatedToTitle, updateResult.Revision.ToString()));
				}
			}
		}
